...
sharedcache = gui.GetValue("rbot.accuracy.weapon.shared.mindmg")
...
callbacks.Register("Draw", function()
	...
	if toggledmg == false then
		...
		gui.SetValue("rbot.accuracy.weapon.shared.mindmg", sharedcache)
	else
		...
		gui.SetValue("rbot.accuracy.weapon.shared.mindmg", mindmg:GetValue())
	end
...
-- doubletap toggle
callbacks.Register("Draw", function()
	gui.SetValue("rbot.accuracy.weapon.pistol.doublefireind",0)
	gui.SetValue("rbot.accuracy.weapon.hpistol.doublefireind",0)
	gui.SetValue("rbot.accuracy.weapon.smg.doublefireind",0)
	gui.SetValue("rbot.accuracy.weapon.lmg.doublefireind",0)
	gui.SetValue("rbot.accuracy.weapon.asniper.doublefireind",0)
	gui.SetValue("rbot.accuracy.weapon.sniper.doublefireind",0)
	gui.SetValue("rbot.accuracy.weapon.scout.doublefireind",0)
	gui.SetValue("rbot.accuracy.weapon.shared.doublefireind",0)
	gui.SetValue("rbot.accuracy.weapon.shotgun.doublefireind",0)
	if toggledt == false then
		...
		gui.SetValue("rbot.accuracy.weapon.shared.doublefire", 2)
